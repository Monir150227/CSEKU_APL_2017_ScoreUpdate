...
$id;
//select team a id from team table
...
// insert player name into player table
$name=$_POST["p_name1"];
...
<title>Team B Player Details</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Team B Player Details</a></h1>
		<form id="index1_2" class="appnitro"  method="post" action="toss.php">
					<div class="form_description">
			<h2>Team B Player Details</h2>
